...
public class TransactionPoint {
    ...
    @GenericGenerator(name = "custom_id", type = com.magicpostapi.components.CustomGeneratedId.class, parameters = {
            @Parameter(name = "prefix", value = "TSP_"),
            @Parameter(name = "field", value = "transactionpoint") })
    ...
    public TransactionPoint(String address, String city, String name) {
        this.address = address;
        this.city = city;
        this.name = name;
        // this.active = active;
    ...
    public TransactionPoint(String address) {
        this.address = address;
        // this.active = active;
    }
